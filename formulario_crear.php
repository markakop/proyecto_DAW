<form class="form-event">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="event-location" placeholder="Ingrese la localización del evento">
  </div>
  <div class="form-group">
    <label for="event-url">URL de la página del evento</label>
    <input type="url" class="form-control" id="event-url" placeholder="Ingrese la URL de la página del evento">
  </div>
  <div class="form-group">
    <label for="event-image-url">URL de la imagen del evento</label>
    <input type="url" class="form-control" id="event-image-url" placeholder="Ingrese la URL de la imagen del evento">
  </div>
